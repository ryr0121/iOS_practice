...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(
            self,
            selector: #selector(editDiaryNotificaton(_:)),
    ...
    @objc func editDiaryNotificaton(_ notification: Notification){
    ...
    private func loadDiaryList() {
        ...
        self.diaryList = date.compactMap {
            guard let uuidString = $0["uuidString"] as? String else { return }
